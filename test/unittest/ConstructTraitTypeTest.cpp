...
int main(int argc, char **argv) {
	...
	try {
		...
		TEST(expr2expr, getConstructTraitTypeFromString(toString(ConstructTraitType::CTExpression)),
				 ConstructTraitType::CTExpression)
		TEST(stmt2stmt, getConstructTraitTypeFromString(toString(ConstructTraitType::CTStatement)),
				 ConstructTraitType::CTStatement)
		TEST(omp2omp, getConstructTraitTypeFromString(toString(ConstructTraitType::CTOpenMPStatement)),
				 ConstructTraitType::CTOpenMPStatement)
		TEST(loop2loop, getConstructTraitTypeFromString(toString(ConstructTraitType::CTLoopStatement)),
				 ConstructTraitType::CTLoopStatement)
		TEST(cond2cond, getConstructTraitTypeFromString(toString(ConstructTraitType::CTConditionalStatement)),
				 ConstructTraitType::CTConditionalStatement)
		TEST(scope2scope, getConstructTraitTypeFromString(toString(ConstructTraitType::CTScopeStatement)),
				 ConstructTraitType::CTScopeStatement)
		TEST(simple2simple, getConstructTraitTypeFromString(toString(ConstructTraitType::CTSimpleStatement)),
				 ConstructTraitType::CTSimpleStatement)
		TEST(wrap2wrap, getConstructTraitTypeFromString(toString(ConstructTraitType::CTWrappableStatement)),
				 ConstructTraitType::CTWrappableStatement)
		TEST(func2func, getConstructTraitTypeFromString(toString(ConstructTraitType::CTFunction)),
				 ConstructTraitType::CTFunction)
		TEST(file2file, getConstructTraitTypeFromString(toString(ConstructTraitType::CTFileScope)),
				 ConstructTraitType::CTFileScope)
		TEST(glob2glob, getConstructTraitTypeFromString(toString(ConstructTraitType::CTGlobalScope)),
