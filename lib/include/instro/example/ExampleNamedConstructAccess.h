...
namespace NamedConstructAccess {
				...
				public:
					...
					std::unique_ptr<InstRO::Core::ConstructSet> getConstructsByIdentifyerName(::InstRO::Tooling::NamedConstructAccess::Matcher & matcher) override{
						...
						{
							if (matcher.isMatch(identifyer)) csci.put(std::make_shared<InstRO::Example::Core::ExampleConstruct>(InstRO::Example::Core::ExampleConstruct(InstRO::Core::ConstructLevelType::CLFunction,identifyer)));
						}
						return std::unique_ptr<InstRO::Core::ConstructSet>(cs);
					};
					std::unique_ptr<InstRO::Core::ConstructSet> getConstructsByUserTextStringMatch(::InstRO::Tooling::NamedConstructAccess::Matcher & matcher) override{
						InstRO::Core::ConstructSet *cs = new InstRO::Core::ConstructSet();
						InstRO::InfracstructureInterface::ConstructSetCompilerInterface csci(cs);
						for (auto identifyer : userTextStrings)
						{
							if (matcher.isMatch(identifyer)) csci.put(std::make_shared<InstRO::Example::Core::ExampleConstruct>(InstRO::Example::Core::ExampleConstruct(InstRO::Core::ConstructLevelType::CLExpression,identifyer)));
						}
						return std::unique_ptr<InstRO::Core::ConstructSet>(cs);
					}; 
