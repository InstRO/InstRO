#ifndef INSTRO_CORE_ORDEROFREGISTRATION_PASSMANAGER_H
#define INSTRO_CORE_ORDEROFREGISTRATION_PASSMANAGER_H
...
/**
 * The OrderOfRegistrationBasedPassManager does not generate depence graphs.
 ...
 */
	class OrderOfRegistrationBasedPassManager : public InstRO::PassManagement::PassManager {
 public:
	 OrderOfRegistrationBasedPassManager(){};

	 virtual ~OrderOfRegistrationBasedPassManager() {
		for (Pass *p : passList) {
			delete p;
		}
	}
	...
	/** In a simple pass manager this function should just be left blank? */
