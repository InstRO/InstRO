...
public:
    ...
    // XXX 2013-01-17 JPL: Maybe add another flag here whether its wild card or specific routine (leads to less string compares)
    bool isRoutineInFileToBeInstrumented(std::string routinename, std::string filename); // To retrieve whether a routine is in a certain file to be instrumented
