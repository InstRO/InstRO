 ...
 *
 * setUpFunctionDefinitionInstrumentationEnvironment(SgFunctionDefinition* funcDef) - which gets called at each
 *SgFunctionDefinition first
 * createEntryFunctionExpressionStatement(SgScopeStatement* scope) - a call to this function will be inserted at the
 *beginning of the function definition
 * createExitFunctionExpressionStatement(SgScopeStatement* scope) - a call to this function will be inserted at each
 *possible return from the function definition
 *
