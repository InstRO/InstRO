...
namespace NamedConstructAccess {
				...
				*/
				...
				public:
					...
					void setMatchMax(){ continueDescend = false;  preOrderMatch = true; postOrderMatch = false; };
					void setMatchMin(){ postOrderMatch = true; preOrderMatch = false; //continueDescend does not apply
					};
