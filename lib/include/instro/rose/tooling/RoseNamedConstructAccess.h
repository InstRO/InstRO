...
public:
	...
	InstRO::Core::ConstructSet match(InstRO::Tooling::NamedConstructAccess::Matcher * matcher, SgProject * proj){
...
public:
	...
	Core::ConstructSet getConstructsByName(InstRO::Tooling::NamedConstructAccess::Matcher &) override{
		//CI: query the ROSE AST for All Construct Fullfilling the Matcher. Here we use a PrePostOrderTraversal
		traversal.reset();
	};
	Core::ConstructSet getConstructsByName(InstRO::Tooling::NamedConstructAccess::Matcher *) override;
};
