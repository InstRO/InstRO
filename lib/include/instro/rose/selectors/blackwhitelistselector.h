...
private:
    std::string whiteListSpecification;	/**< The suffix for a line, if the specified function name is to be put on the whitelist */
    std::string blackListSpecification;	/**< The suffix for a line, if the specified function name is to be put on the blacklist */
    ...
    /** To avoid redundant code, this function takes a line from the input file, truncates it and adds it to the given list */
