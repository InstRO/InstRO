			...
			public:
				...
				virtual void execute() {
					...
					for (auto construct : csci)	{
						...
						for (auto constructTrait = InstRO::Core::ConstructTraitType::CTExpression; constructTrait != InstRO::Core::ConstructTraitType::CTMax; constructTrait++)
						{		
