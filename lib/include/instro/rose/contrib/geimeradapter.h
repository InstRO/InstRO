 ...
 * to the name of your source file. So as you want to instrument foo.cpp you will need foo.cfg - for bar.cpp a bar.cfg,
 *respectively.
 *
...
class GeimerAdapterBuilder : public AdapterBuilder {
 public:
	/** The selector passed should be a GeimerSelector. If not this will result in undefined behaviour. (May include Seg
	 * faults.) */
