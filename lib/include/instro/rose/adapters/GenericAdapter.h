...
namespace Rose
{
	namespace Adapters
	{
		...
		public:
			...
			GenericAdapter(Pass * functionInstrumentation, Pass * loopInstrumentation, Pass * loopBodyInstrumentation) :RosePass(InstRO::Core::ChannelConfiguration(functionInstrumentation, loopInstrumentation, loopBodyInstrumentation))
			{
