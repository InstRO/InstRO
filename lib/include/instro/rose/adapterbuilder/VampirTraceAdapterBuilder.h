...
/**
 * \brief This adapter builder inserts __cyg_profile_func_enter / exit like the CygProfileFunctionAdapterBuilder does
 *but it uses "pseudo function ids" which are generated at compile time.
 *
 ...
 * The adapter builder appends to the InstRO_nmfile and uses this file to check whether it should start numbering with
 *an index of 1 or variable.
