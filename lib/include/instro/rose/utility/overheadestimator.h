...
public:
	OverheadEstimator(SgProject* project, Selector* selector) : selector(selector), cgm(project), approxAdditionalCycles(0), approxAdditionalNanos(0), numberOfFunctions(0), numberOfFunctionsToInstrument(0), additionalCycles(42), additionalNanos(12345){};
...
public:
	OverheadEstimator2(Selector* selector, SgProject* project) : CallFrequencyHeuristicSelector(project, 1, 1), selector(selector){};
