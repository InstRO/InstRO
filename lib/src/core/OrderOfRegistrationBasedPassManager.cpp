...
void InstRO::PassManagement::OrderOfRegistrationBasedPassManager::registerPass(Pass *currentPass) {
	passList.push_back(currentPass);
}

int InstRO::PassManagement::OrderOfRegistrationBasedPassManager::execute() {
	logIt(INFO) << "InstRO::PassManagement::OrderOfRegistrationBasedPassManager::execute()" << std::endl;
