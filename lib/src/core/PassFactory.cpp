...
Pass* PassFactory::createBooleanAndSelector(Pass* inputA, Pass* inputB) {
	...
	Pass* newPass = new Pass(new Selector::BooleanCompoundSelector(Selector::BooleanCompoundSelector::CO_AND),
													 InstRO::Core::ChannelConfiguration(ConfigTuple(0,inputA), ConfigTuple(1,inputB)), "InstRO::Selector::BooleanAndSelector");
...
Pass* PassFactory::createBooleanXorSelector(Pass* inputA, Pass* inputB) {
	...
	Pass* newPass = new Pass(new Selector::BooleanCompoundSelector(Selector::BooleanCompoundSelector::CO_XOR),
													 InstRO::Core::ChannelConfiguration(ConfigTuple(0,inputA), ConfigTuple(1,inputB)), "InstRO::Selector::BooleanXorSelector");
...
Pass* PassFactory::createBooleanMinusSelector(Pass* inputA, Pass* inputB) {
	...
	Pass* newPass = new Pass(new Selector::BooleanCompoundSelector(Selector::BooleanCompoundSelector::CO_MINUS),
													 InstRO::Core::ChannelConfiguration(ConfigTuple(0,inputA), ConfigTuple(1,inputB)), "InstRO::Selector::BooleanMinusSelector");
...
Pass* PassFactory::createConstructRaisingElevator(Pass* pass, InstRO::Core::ConstructTraitType level) {
	Pass* newPass = new Pass(new Selector::ConstructRaisingElevator(level), InstRO::Core::ChannelConfiguration(pass), "InstRO::Selector::ConstructRaisingElevator");
...
Pass* PassFactory::createConstructLoweringElevator(Pass* pass, InstRO::Core::ConstructTraitType level) {
	Pass* newPass = new Pass(new Selector::ConstructLoweringElevator(level), InstRO::Core::ChannelConfiguration(pass), "InstRO::Selector::ConstructLoweringElevator");
...
Pass* PassFactory::createConstructCroppingElevator(Pass* pass, InstRO::Core::ConstructTraitType minLevel,
	...
	Pass* newPass =
			new Pass(new Selector::ConstructCroppingElevator(minLevel, maxLevel), InstRO::Core::ChannelConfiguration(pass), "InstRO::Selector::ConstructCroppingElevator");
...
Pass* PassFactory::createProgramEntrySelector() {
	Pass* newPass = new Pass(new Selector::ProgramEntrySelector(), InstRO::Core::ChannelConfiguration(), "InstRO::Selector::ProgramEntrySelector");
...
Pass* PassFactory::createIdentifierMatcherSelector(std::vector<std::string> matchList) {
	Pass* newPass = new Pass(new Selector::IdentifyerSelector(matchList), InstRO::Core::ChannelConfiguration(), "InstRO::Rose::IdentifyerSelector");
...
Pass* PassFactory::createCallpathSelector(Pass* callee, Pass* caller, std::string dotName) {
	...
	Pass* newPass = new Pass(new Selector::CallPathSelector(dotName),
													 InstRO::Core::ChannelConfiguration(ConfigTuple(0, callee), ConfigTuple(1, caller)), "InstRO::Selector::CallPathSelector");
...
Pass* PassFactory::createConstructClassSelector(InstRO::Core::ConstructTraitType constructClass) {
	Pass* newPass = new Pass(new Selector::ConstructClassSelector(constructClass), InstRO::Core::ChannelConfiguration(), "InstRO::Selector::ConstructClassSelector");
...
Pass* PassFactory::createConstructPrinterAdapter(Pass* pass) {
	Pass* newPass = new Pass(new InstRO::Adapter::ConstructPrinterAdapter(), InstRO::Core::ChannelConfiguration(pass), "InstRO::Adapter::ConstructPrinterAdapter");
