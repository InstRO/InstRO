...
std::unique_ptr<InstRO::Core::ConstructSet> RoseGrammarInterface::getConstructsByType(const InstRO::Tooling::GrammarInterface::GrammarTypesType &types){
...
std::list<InstRO::Tooling::GrammarInterface::GrammarTypesType> RoseGrammarInterface::getGrammerTypes(const InstRO::Core::ConstructSet &cs) {
