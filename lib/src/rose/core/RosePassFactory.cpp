...
Pass* RosePassFactory::createDefaultInstrumentationAdapter(InstRO::Pass* input) {
	Pass* newPass = new Pass(new InstRO::Rose::Adapter::RoseDefaultInstrumentationAdapter(project), InstRO::Core::ChannelConfiguration(input));
...
InstRO::Pass* RosePassFactory::createRoseMatthiasZoellnerLoopInstrumentationAdapter(InstRO::Pass* pass) {
	...
	Pass* newPass = new Pass(new InstRO::Rose::Adapter::RoseStrategyBasedAdapter(std::move(my_strategy), std::move(my_strategy2), std::move(my_strategy3)), InstRO::Core::ChannelConfiguration(pass));
...
InstRO::Pass* RosePassFactory::createRoseUniqueCallpathTransformer(InstRO::Pass* input) {
	...
	cfg.setConstructLevel(input, InstRO::Core::ConstructTraitType::CTFunction, InstRO::Core::ConstructTraitType::CTFunction);

	InstRO::Pass* newPass = new InstRO::Pass(new Transformer::RoseUniqueCallpathTransformer(Transformer::RoseUniqueCallpathTransformer::Mode::nMode), cfg);
...
InstRO::Pass* RosePassFactory::createRoseUniqueCallpathTransformer(Pass* input, Pass* root, Pass* active) {
	...
	InstRO::Pass* newPass = new InstRO::Pass(new Transformer::RoseUniqueCallpathTransformer(m), InstRO::Core::ChannelConfiguration(input, root, active));
	newPass->setPassName("InstRO::Rose::Transformer::RoseUniqueCallpathTransformer");
	passManager->registerPass(newPass);
	return newPass;
}
...
InstRO::Pass* RosePassFactory::createRoseFunctionWrapper(
	...
	InstRO::Core::ChannelConfiguration cfg(input);
	cfg.setConstructLevel(input, InstRO::Core::ConstructTraitType::CTExpression, InstRO::Core::ConstructTraitType::CTFunction);
...
InstRO::Pass* RosePassFactory::createRoseFunctionWrapper(
	...
	cfg.setConstructLevel(input, InstRO::Core::ConstructTraitType::CTExpression, InstRO::Core::ConstructTraitType::CTFunction);
	cfg.setConstructLevel(renaming, InstRO::Core::ConstructTraitType::CTExpression, InstRO::Core::ConstructTraitType::CTGlobalScope);
	 InstRO::Pass* newPass = new InstRO::Pass(
			new Transformer::RoseFunctionWrapper(nameTransformer, definitionPrefix, wrapperPrefix), cfg);
	newPass->setPassName("InstRO::Rose::Transformer::RoseFunctionWrapper");
	passManager->registerPass(newPass);
	return newPass;
}
...
InstRO::Pass* RosePassFactory::createRoseMPIFunctionWrapper(InstRO::Pass* input) {
	InstRO::Pass* newPass = new InstRO::Pass(new Transformer::RoseMPIFunctionWrapper(), InstRO::Core::ChannelConfiguration(input));
...
InstRO::Pass* RosePassFactory::createRoseMPIFunctionWrapper(InstRO::Pass* input, InstRO::Pass* renaming,
																												...
																												const std::string& wrapperPrefix) {
	InstRO::Pass* newPass =
			new InstRO::Pass(new Transformer::RoseMPIFunctionWrapper(definitionPrefix, wrapperPrefix), InstRO::Core::ChannelConfiguration(input, renaming));
	newPass->setPassName("InstRO::Rose::Transformer::RoseMPIFunctionWrapper");
	passManager->registerPass(newPass);
	return newPass;
}
