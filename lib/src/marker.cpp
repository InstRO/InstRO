 ...
 *
 */
void ASTAttributeContainer::remSelAttrib(size_t selId) { this->selectorMarkerMap.erase(selId); }
 ...
 *
 */
Selector* SelectionASTMarker::getSelectingSelector() { return this->selectingSelector; }
...
NameMatchingSelectionASTMarker::NameMatchingSelectionASTMarker(Selector* sel) { this->select(sel); }

void NameMatchingSelectionASTMarker::addMatchToList(std::string str) { matches.push_back(str); }

std::list<std::string> NameMatchingSelectionASTMarker::getMatches() { return matches; }

BWSelectionASTMarker::BWSelectionASTMarker(Selector* selectingSelector) { this->selectingSelector = selectingSelector; }

Selector* BWSelectionASTMarker::getSelectingSelector() { return this->selectingSelector; }
 ...
 */
std::vector<int> BWSelectionASTMarker::getListOfMatchingIds() { return matchingIdsList; }
...
*/
Selector* CompoundSelectionASTMarker::getSelectingSelector() { return this->selectingSelector; }

/* --- Geimer Selector --- */
void GeimerSelectionASTMarker::setSpecNodes(std::vector<SgNode*> nodes) { this->specNodes = nodes; }

void GeimerSelectionASTMarker::setIncludeFiles(std::vector<std::string> includeFiles) {
	this->includeFiles = includeFiles;
}

std::vector<SgNode*> GeimerSelectionASTMarker::getSpecNodes() { return this->specNodes; }

std::vector<std::string> GeimerSelectionASTMarker::getIncludeFilenames() { return this->includeFiles; }
